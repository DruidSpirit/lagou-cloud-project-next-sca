...
import com.lagou.edu.sentinel.UserHandles;
...
public class UserHandleControl implements UserHandle {
     ...
     */
    @Override
    @SentinelResource(value = "login",blockHandlerClass = UserHandles.class,
            blockHandler = "loginBlockHandler",fallbackClass = UserHandles.class,fallback = "loginFallback")
    ...
    public ResModel<?> getUserInfo( @PathVariable("tokenId") String tokenId ){
